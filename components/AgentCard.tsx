...
export default function AgentCard({ agent }: { agent: RegistryAgent }) {
  const statusStyles = {
    ...
    degraded: { dot: 'bg-amber-400', ring: 'ring-amber-400/20', text: 'text-amber-200', pill: 'bg-amber-500/10 border-amber-400/20', label: 'Degraded' },
  ...
  return (
    <article className="group relative overflow-hidden rounded-xl xl border border-white/10 bg-zinc-950/60 p-5 backdrop-blur transition-all hover:border-white/20">
