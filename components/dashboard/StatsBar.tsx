  ...
  return (
    <section className="w-full grid grid-cols-4 gap-4">
       <div className="bg-[#1A1A1A] p-4 rounded-xl border border-white/5">
         ...
         <div className="text-white text-xl ifont-bold pt-1">{stats?.mindsOnline ?? "..."}</div>
       </div>
       ...
       <div className="bg-[#1A1A1A] p-4 rounded-xl border border-white/5">
         <div className="text-white text-xs">System Health</div>
         <div className="text-white text-xl ifont-bold pt-1">{stats?.systemHealth ?? "98"}}</div>
       </div>
    </section>
  );
}
